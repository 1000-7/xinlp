...
public class DoubleArrayTrie<V> implements Serializable {
    ...
    private int build(Set<Map.Entry<String, V>> entrySet) {
    ...
    private int build(List<String> keyList, List<V> valueList) {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("DoubleArrayTrie{");
        sb.append("check=").append(Arrays.toString(check));
        sb.append(", base=").append(Arrays.toString(base));
        sb.append(", used=").append(Arrays.toString(used));
        sb.append(", size=").append(size);
        sb.append(", allocSize=").append(allocSize);
        sb.append(", key=").append(key);
        sb.append(", keySize=").append(keySize);
        sb.append(", length=").append(Arrays.toString(length));
        sb.append(", value=").append(Arrays.toString(value));
        sb.append(", progress=").append(progress);
        sb.append(", nextCheckPos=").append(nextCheckPos);
        sb.append(", error_=").append(error_);
        sb.append('}');
        return sb.toString();
    }
}